...
- [What is this project ?](What does this code do)
- [HTTP Verbs](HTTP Verbs)
- [Request and Response Examples](Request and Response Examples)
- [Schemas of User and Account](Schemas of User and Account)
...
1. User Examples
     ...
     - [PUT /users/update/{user_id}](/users/update/{user_id})
     - [GET /users/{user_id}](/users/{user_id})
     
    
2. Account Examples
     - [POST /accounts/create_account](/accounts/create_account)
     - [PUT /accounts/update/{account_id}](/accounts/update/{account_id})
